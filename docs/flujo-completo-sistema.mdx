...
| Path | Nombre | Componente | Descripción |
|---|---|---|---|
| `/app/reports` | `Reports` | `ReportsView.vue` | Menú selector de reportes |
...
| `/app/reports/purchases` | `PurchasesReport` | `PurchasesReportView.vue` | **NUEVO:** Compras por proveedor, fecha, categoría |
| `/app/reports/financial` | `FinancialReport` | `FinancialReportView.vue` | **NUEVO:** Ingresos, egresos, ITBIS, balance, flujo caja |

### 3.16 Módulo de Ecommerce (Admin)

Layout padre: `EcommerceView.vue`.
...
**Total: ~65 rutas definidas** (+10 nuevas respecto a la versión anterior)
