<template>
  <footer class="w-full relative bottom-0 bg-surface-container-lowest/50 backdrop-blur-md border-t border-white/5">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-desktop py-20 max-w-7xl mx-auto">
      <div class="flex flex-col gap-6">
        <a href="#hero" class="font-headline-md text-headline-md text-primary font-bold">Animal Store</a>
        <p class="font-body-md text-body-md text-on-surface-variant">Defining the future of the human-animal connection through design and wellness.</p>
      </div>
      ...
      <div class="flex flex-col gap-4">
        ...
        <a href="#newsletter" class="font-body-md text-body-md text-on-surface-variant hover:text-on-surface transition-all">Contacto</a>
    ...
    <div class="px-margin-desktop py-8 border-t border-white/5 text-center">
      <p class="font-body-md text-body-md text-on-surface-variant opacity-60">© 2024 Animal Store. The Art of Pet Care.</p>
    </div>
  </footer>
</template>
